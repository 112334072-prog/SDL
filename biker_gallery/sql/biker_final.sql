...
-- ============================================================
--  TABLE 6: contacts — customer messages from contact form
-- ============================================================
...
--   (the 'availability' column in menu is no longer used — availability
--    is computed live from the bookings table in api_availability.php)
